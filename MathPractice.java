...
public class MathPractice  {
    public static void main(String[] args) {
        ...
        // Call each method to the function
        calculateTriangleHeight(sc);
        calculateCompoundInterest(sc);
        convertCartesianToPolar(sc);
        calculateDistanceBetweenPoints(sc);
    ...
    public static void calculateTriangleHeight(Scanner sc) {
        System.out.println("\nEquation 1: Calculate the height of a right triangle.");
        System.out.print("Enter base (b): ");
        double b = sc.nextDouble();
        System.out.print("Enter angle (theta in degrees): ");
        double theta = sc.nextDouble();  // Changed from int to double
    ...
    public static void calculateCompoundInterest(Scanner sc) {
        ...
        double P = sc.nextDouble();  // Corrected scanner variable and used double instead of int
        System.out.print("Enter Annual Interest Rate (r as a decimal): ");
        double r = sc.nextDouble();  // Corrected to use double instead of int
        System.out.print("Enter Number of Compounds per Year (n): ");
        int n = sc.nextInt();
        System.out.print("Enter Time in Years (t): ");
        double t = sc.nextDouble();  // Changed to double
        double A = P * Math.pow(1 + r / n, n * t);  // Fixed Math.POW to Math.pow
        System.out.println("Total Amount: " + A);
    }

    // Equation 3: Cartesian to Polar
    public static void convertCartesianToPolar(Scanner sc) {
        ...
        double thetaPolar = Math.toDegrees(Math.atan2(y, x));  // Used atan2 for correct quadrant determination
        System.out.println("Radius: " + rPolar + ", Angle: " + thetaPolar + "°");
    }

    // Equation 4: Calculate distance between two points
    public static void calculateDistanceBetweenPoints(Scanner sc) {
        System.out.println("\nEquation 4: Calculate Distance Between Two Points.");
